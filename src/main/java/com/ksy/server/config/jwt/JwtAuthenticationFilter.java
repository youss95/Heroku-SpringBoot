	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if(!method.equals("POST")) {
			...
			try {
				...
				//User getUserPw = personRepository.findByUsername(authDto.getUsername());
				User personEntity = personRepository.findByUsernameAndPassword(authDto.getUsername(),authDto.getPassword());
